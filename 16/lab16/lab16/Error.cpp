...
namespace Error
{
	//ñåğèè îøèáîê: 0 - 90 ñèñòåìíûå îøèáêè
	//             100 - 109 îøèáêè ïàğàìåòğîâ
	//             110 - 119 îøèáêè îòêğûòèÿ è ÷òíèÿ ôàéëîâ
	ERROR errors[ERROR_MAX_ENTRY] = // òàáëèöà îøèáîê
	{
		...
		ERROR_ENTRY(115, "Íåñîâïàäåíèå òèïà"),
		...
		ERROR_ENTRY(605, "Îøèáêà â àğèôìåòè÷åñêîì âûğàæåíèè"), 
